...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UQuestNode_Statics::NewProp_LastExecTime = { "LastExecTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UQuestNode, LastExecTime), Z_Construct_UScriptStruct_FDateTime, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UQuestNode_Statics::NewProp_LastExecTime_MetaData), Z_Construct_UClass_UQuestNode_Statics::NewProp_LastExecTime_MetaData) };
#if WITH_METADATA
...
void FOnStateReachedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnStateReachedEvent)
{
	...
	struct Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::EnumInfo[] = {
		{ EStateNodeType_StaticEnum, TEXT("EStateNodeType"), &Z_Registration_Info_UEnum_EStateNodeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4154942743U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ScriptStructInfo[] = {
		{ FQuestTask::StaticStruct, Z_Construct_UScriptStruct_FQuestTask_Statics::NewStructOps, TEXT("QuestTask"), &Z_Registration_Info_UScriptStruct_QuestTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestTask), 556913053U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQuestNode, UQuestNode::StaticClass, TEXT("UQuestNode"), &Z_Registration_Info_UClass_UQuestNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestNode), 3561026975U) },
		{ Z_Construct_UClass_UQuestState, UQuestState::StaticClass, TEXT("UQuestState"), &Z_Registration_Info_UClass_UQuestState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestState), 2428562190U) },
		{ Z_Construct_UClass_UQuestBranch, UQuestBranch::StaticClass, TEXT("UQuestBranch"), &Z_Registration_Info_UClass_UQuestBranch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestBranch), 597844746U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_3002535490(TEXT("/Script/Narrative"),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_QuestSM_h_Statics::EnumInfo));
