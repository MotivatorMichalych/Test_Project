...
template<> NARRATIVE_API UScriptStruct* StaticStruct<FDialogueLine>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDialogueNode_Statics::NewProp_AlternativeLines_Inner = { "AlternativeLines", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDialogueLine, METADATA_PARAMS(0, nullptr) }; // 316569442
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDialogueNode_Player_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDialogueNode_Player_GetOptionText, "GetOptionText" }, // 2745333976
	};
	...
	UDialogueNode_Player::~UDialogueNode_Player() {}
	struct Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::EnumInfo[] = {
		{ ELineDuration_StaticEnum, TEXT("ELineDuration"), &Z_Registration_Info_UEnum_ELineDuration, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2098264207U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ScriptStructInfo[] = {
		{ FSpeakerSelector::StaticStruct, Z_Construct_UScriptStruct_FSpeakerSelector_Statics::NewStructOps, TEXT("SpeakerSelector"), &Z_Registration_Info_UScriptStruct_SpeakerSelector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpeakerSelector), 2755830409U) },
		{ FDialogueLine::StaticStruct, Z_Construct_UScriptStruct_FDialogueLine_Statics::NewStructOps, TEXT("DialogueLine"), &Z_Registration_Info_UScriptStruct_DialogueLine, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialogueLine), 316569442U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueNode, UDialogueNode::StaticClass, TEXT("UDialogueNode"), &Z_Registration_Info_UClass_UDialogueNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueNode), 4192536724U) },
		{ Z_Construct_UClass_UDialogueNode_NPC, UDialogueNode_NPC::StaticClass, TEXT("UDialogueNode_NPC"), &Z_Registration_Info_UClass_UDialogueNode_NPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueNode_NPC), 135766919U) },
		{ Z_Construct_UClass_UDialogueNode_Player, UDialogueNode_Player::StaticClass, TEXT("UDialogueNode_Player"), &Z_Registration_Info_UClass_UDialogueNode_Player, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueNode_Player), 3284804416U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_1692931281(TEXT("/Script/Narrative"),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_DialogueSM_h_Statics::EnumInfo));
