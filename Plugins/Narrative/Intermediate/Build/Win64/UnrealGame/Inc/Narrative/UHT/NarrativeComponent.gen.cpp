...
template<> NARRATIVE_API UScriptStruct* StaticStruct<FNarrativeUpdate>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNarrativeUpdate_Statics::Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/NarrativeComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Right now UQuests aren't replicated the proper UE way (replicated flag on objects), because this is really complex and hasn't been very successful in testing.\nIt would also hog a lot more network performance, as quests often have hundreds of states, tasks, and branches,\nall of which would be sending network updates and replicating.\n\nSo in the meantime, the server authoritatively Begins, Forgets, Restarts, Updates quests etc, and then informs the client about\nthese changes via the FNarrativeUpdate stream so the clients can \"replay\" these actions in the order they happened and keep sync with the server.\n\nUsing this mechanism instead of RPCs ensures the updates are sent in the correct order. This is really important\nfor ensuring the client correctly stays in sync with the server." },
#endif
	};
#endif
...
void FOnDialogueFinished_DelegateWrapper(const FMulticastScriptDelegate& OnDialogueFinished, UDialogue* Dialogue)
{
	struct _Script_Narrative_eventOnDialogueFinished_Parms
	{
		UDialogue* Dialogue;
...
void FOnLoadComplete_DelegateWrapper(const FMulticastScriptDelegate& OnLoadComplete, const FString& SaveGameName)
{
	...
	DEFINE_FUNCTION(UNarrativeComponent::execServerSelectSharedDialogueOption)
	{
		P_GET_PROPERTY(FNameProperty,Z_Param_OptionID);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ServerSelectSharedDialogueOption_Implementation(Z_Param_OptionID);
		P_NATIVE_END;
	}
	...
	{
		P_GET_PROPERTY(FNameProperty,Z_Param_OptionID);
		P_GET_OBJECT(APawn,Z_Param_Selector);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UNarrativeComponent::execClientBeginSharedDialogue)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ClientBeginSharedDialogue_Implementation(Z_Param_Dialogue,Z_Param_NPC,Z_Param_NPCReplyChainIDs,Z_Param_AvailableResponseIDs);
		P_NATIVE_END;
	}
	...
	{
		P_GET_OBJECT(UClass,Z_Param_Dialogue);
		P_GET_OBJECT(AActor,Z_Param_DefaultNPCAvatar);
		P_GET_PROPERTY(FNameProperty,Z_Param_StartFromID);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->BeginDialogue(Z_Param_Dialogue,Z_Param_DefaultNPCAvatar,Z_Param_StartFromID);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UNarrativeComponent::execHasDialogueAvailable)
	{
		P_GET_OBJECT(UClass,Z_Param_Dialogue);
		P_GET_OBJECT(AActor,Z_Param_DefaultAvatar);
		P_GET_PROPERTY(FNameProperty,Z_Param_StartFromID);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->HasDialogueAvailable(Z_Param_Dialogue,Z_Param_DefaultAvatar,Z_Param_StartFromID);
		P_NATIVE_END;
	}
	...
	struct NarrativeComponent_eventClientBeginSharedDialogue_Parms
	{
		TSubclassOf<UDialogue>  Dialogue;
		AActor* NPC;
		TArray<FName> NPCReplyChainIDs;
	...
	struct NarrativeComponent_eventServerSelectSharedDialogueOption_Parms
	{
		FName OptionID;
	};
	...
	static FName NAME_UNarrativeComponent_ClientBeginSharedDialogue = FName(TEXT("ClientBeginSharedDialogue"));
	void UNarrativeComponent::ClientBeginSharedDialogue(TSubclassOf<UDialogue>  Dialogue, AActor* NPC, TArray<FName> const& NPCReplyChainIDs, TArray<FName> const& AvailableResponseIDs)
	{
		NarrativeComponent_eventClientBeginSharedDialogue_Parms Parms;
		Parms.Dialogue=Dialogue;
		Parms.NPC=NPC;
		Parms.NPCReplyChainIDs=NPCReplyChainIDs;
		Parms.AvailableResponseIDs=AvailableResponseIDs;
		ProcessEvent(FindFunctionChecked(NAME_UNarrativeComponent_ClientBeginSharedDialogue),&Parms);
	}
	...
	void UNarrativeComponent::ClientSelectDialogueOption(FName const& OptionID, APawn* Selector)
	{
	...
	static FName NAME_UNarrativeComponent_ServerSelectSharedDialogueOption = FName(TEXT("ServerSelectSharedDialogueOption"));
	void UNarrativeComponent::ServerSelectSharedDialogueOption(FName const& OptionID)
	{
		NarrativeComponent_eventServerSelectSharedDialogueOption_Parms Parms;
		Parms.OptionID=OptionID;
		ProcessEvent(FindFunctionChecked(NAME_UNarrativeComponent_ServerSelectSharedDialogueOption),&Parms);
	}
	...
	void UNarrativeComponent::StaticRegisterNativesUNarrativeComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ClientBeginSharedDialogue", &UNarrativeComponent::execClientBeginSharedDialogue },
			...
			{ "ServerSelectSharedDialogueOption", &UNarrativeComponent::execServerSelectSharedDialogueOption },
	...
	struct Z_Construct_UFunction_UNarrativeComponent_BeginDialogue_Statics
	{
		...
		{
			TSubclassOf<UDialogue>  Dialogue;
			AActor* DefaultNPCAvatar;
			FName StartFromID;
			bool ReturnValue;
		};
		static const UECodeGen_Private::FClassPropertyParams NewProp_Dialogue;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_DefaultNPCAvatar;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_BeginDialogue_Statics::NewProp_DefaultNPCAvatar = { "DefaultNPCAvatar", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventBeginDialogue_Parms, DefaultNPCAvatar), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeComponent_BeginDialogue_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_BeginDialogue_Statics::NewProp_DefaultNPCAvatar,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_BeginDialogue_Statics::Function_MetaDataParams[] = {
		...
		{ "DefaultToSelf", "DefaultNPCAvatar" },
		{ "ModuleRelativePath", "Public/NarrativeComponent.h" },
#if !UE_BUILD_SHIPPING
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginDialogue_Statics::NewProp_NPC = { "NPC", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientBeginDialogue_Parms, NPC), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	struct Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics
	{
		static const UECodeGen_Private::FClassPropertyParams NewProp_Dialogue;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_NPC;
		static const UECodeGen_Private::FNamePropertyParams NewProp_NPCReplyChainIDs_Inner;
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_Dialogue = { "Dialogue", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientBeginSharedDialogue_Parms, Dialogue), Z_Construct_UClass_UClass, Z_Construct_UClass_UDialogue_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPC = { "NPC", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientBeginSharedDialogue_Parms, NPC), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs_Inner = { "NPCReplyChainIDs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs = { "NPCReplyChainIDs", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientBeginSharedDialogue_Parms, NPCReplyChainIDs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs_MetaData), Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs = { "AvailableResponseIDs", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientBeginSharedDialogue_Parms, AvailableResponseIDs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs_MetaData), Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_Dialogue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPC,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_NPCReplyChainIDs,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::NewProp_AvailableResponseIDs,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::Function_MetaDataParams[] = {
		{ "Category", "Dialogues" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**Used by the server to tell client to start dialogue. Also sends the initial chunk*/" },
#endif
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "ClientBeginSharedDialogue", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::PropPointers), sizeof(NarrativeComponent_eventClientBeginSharedDialogue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x01020CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::PropPointers) < 2048);
	static_assert(sizeof(NarrativeComponent_eventClientBeginSharedDialogue_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientReceiveSave_Statics::NewProp_SavedQuests_Inner = { "SavedQuests", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNarrativeSavedQuest, METADATA_PARAMS(0, nullptr) }; // 995784827
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_ClientSelectDialogueOption_Statics::NewProp_Selector = { "Selector", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventClientSelectDialogueOption_Parms, Selector), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::NewProp_QuestClass = { "QuestClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventGetQuest_Parms, QuestClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UQuest_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventGetQuest_Parms, ReturnValue), Z_Construct_UClass_UQuest_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "GetQuest", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::NarrativeComponent_eventGetQuest_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UNarrativeComponent_GetQuest_Statics::NarrativeComponent_eventGetQuest_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_QuestClass = { "QuestClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventHasCompletedTaskInQuest_Parms, QuestClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UQuest_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Task = { "Task", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventHasCompletedTaskInQuest_Parms, Task), Z_Construct_UClass_UNarrativeDataTask_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Task_MetaData), Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Task_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventHasCompletedTaskInQuest_Parms, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Name_MetaData), Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeComponent_eventHasCompletedTaskInQuest_Parms), &Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "HasCompletedTaskInQuest", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NarrativeComponent_eventHasCompletedTaskInQuest_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest_Statics::NarrativeComponent_eventHasCompletedTaskInQuest_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_UNarrativeComponent_HasDialogueAvailable_Statics
	{
		...
		{
			TSubclassOf<UDialogue>  Dialogue;
			AActor* DefaultAvatar;
			FName StartFromID;
			bool ReturnValue;
		};
		static const UECodeGen_Private::FClassPropertyParams NewProp_Dialogue;
		static const UECodeGen_Private::FObjectPropertyParams NewProp_DefaultAvatar;
		static const UECodeGen_Private::FNamePropertyParams NewProp_StartFromID;
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_HasDialogueAvailable_Statics::NewProp_DefaultAvatar = { "DefaultAvatar", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventHasDialogueAvailable_Parms, DefaultAvatar), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeComponent_HasDialogueAvailable_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_HasDialogueAvailable_Statics::NewProp_DefaultAvatar,
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::NewProp_Option = { "Option", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventSelectDialogueOption_Parms, Option), Z_Construct_UClass_UDialogueNode_Player_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "SelectDialogueOption", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::NarrativeComponent_eventSelectDialogueOption_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption_Statics::NarrativeComponent_eventSelectDialogueOption_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OptionID_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::NewProp_OptionID_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::NewProp_OptionID = { "OptionID", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventServerSelectSharedDialogueOption_Parms, OptionID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::NewProp_OptionID_MetaData), Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::NewProp_OptionID_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::NewProp_OptionID,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::Function_MetaDataParams[] = {
		{ "Category", "Dialogues" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**Tell the server to select one of its shared options*/" },
#endif
		{ "ModuleRelativePath", "Public/NarrativeComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Tell the server to select one of its shared options" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "ServerSelectSharedDialogueOption", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::PropPointers), sizeof(NarrativeComponent_eventServerSelectSharedDialogueOption_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00220CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::PropPointers) < 2048);
	static_assert(sizeof(NarrativeComponent_eventServerSelectSharedDialogueOption_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::NewProp_NewSharedNarrativeComponent = { "NewSharedNarrativeComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeComponent_eventSetSharedNarrativeComponent_Parms, NewSharedNarrativeComponent), Z_Construct_UClass_UNarrativeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::NewProp_NewSharedNarrativeComponent_MetaData), Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::NewProp_NewSharedNarrativeComponent_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeComponent, nullptr, "SetSharedNarrativeComponent", nullptr, nullptr, Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::NarrativeComponent_eventSetSharedNarrativeComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent_Statics::NarrativeComponent_eventSetSharedNarrativeComponent_Parms) < MAX_uint16);
	...
	struct Z_Construct_UClass_UNarrativeComponent_Statics
	{
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_GroupMembers_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_GroupMembers_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_GroupMembers;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNarrativeComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeComponent_BeginDialogue, "BeginDialogue" }, // 2992698083
		{ &Z_Construct_UFunction_UNarrativeComponent_BeginLoad, "BeginLoad" }, // 1391545547
		{ &Z_Construct_UFunction_UNarrativeComponent_BeginQuest, "BeginQuest" }, // 123130105
		{ &Z_Construct_UFunction_UNarrativeComponent_BeginSave, "BeginSave" }, // 2799808158
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientBeginDialogue, "ClientBeginDialogue" }, // 3783071350
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientBeginSharedDialogue, "ClientBeginSharedDialogue" }, // 1278535509
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientExitDialogue, "ClientExitDialogue" }, // 3527425138
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientReceiveSave, "ClientReceiveSave" }, // 706539373
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientRecieveDialogueChunk, "ClientRecieveDialogueChunk" }, // 638558927
		{ &Z_Construct_UFunction_UNarrativeComponent_ClientSelectDialogueOption, "ClientSelectDialogueOption" }, // 3084847395
		{ &Z_Construct_UFunction_UNarrativeComponent_DeleteSave, "DeleteSave" }, // 2540810770
		{ &Z_Construct_UFunction_UNarrativeComponent_DialogueBegan, "DialogueBegan" }, // 1521430018
		{ &Z_Construct_UFunction_UNarrativeComponent_DialogueFinished, "DialogueFinished" }, // 3254565709
		{ &Z_Construct_UFunction_UNarrativeComponent_DialogueLineFinished, "DialogueLineFinished" }, // 1412018818
		{ &Z_Construct_UFunction_UNarrativeComponent_DialogueLineStarted, "DialogueLineStarted" }, // 2708783566
		{ &Z_Construct_UFunction_UNarrativeComponent_DialogueRepliesAvailable, "DialogueRepliesAvailable" }, // 180257772
		{ &Z_Construct_UFunction_UNarrativeComponent_ForgetQuest, "ForgetQuest" }, // 3348175719
		{ &Z_Construct_UFunction_UNarrativeComponent_GetAllQuests, "GetAllQuests" }, // 3654254544
		{ &Z_Construct_UFunction_UNarrativeComponent_GetCurrentDialogue, "GetCurrentDialogue" }, // 809676632
		{ &Z_Construct_UFunction_UNarrativeComponent_GetFailedQuests, "GetFailedQuests" }, // 970909731
		{ &Z_Construct_UFunction_UNarrativeComponent_GetInProgressQuests, "GetInProgressQuests" }, // 3697035627
		{ &Z_Construct_UFunction_UNarrativeComponent_GetNumberOfTimesTaskWasCompleted, "GetNumberOfTimesTaskWasCompleted" }, // 2994172818
		...
		{ &Z_Construct_UFunction_UNarrativeComponent_GetQuest, "GetQuest" }, // 1226649771
		{ &Z_Construct_UFunction_UNarrativeComponent_GetSucceededQuests, "GetSucceededQuests" }, // 2959064739
		{ &Z_Construct_UFunction_UNarrativeComponent_HasCompletedTask, "HasCompletedTask" }, // 3269161024
		{ &Z_Construct_UFunction_UNarrativeComponent_HasCompletedTaskInQuest, "HasCompletedTaskInQuest" }, // 2984515890
		{ &Z_Construct_UFunction_UNarrativeComponent_HasDialogueAvailable, "HasDialogueAvailable" }, // 1168688206
		{ &Z_Construct_UFunction_UNarrativeComponent_IsInDialogue, "IsInDialogue" }, // 350863606
		{ &Z_Construct_UFunction_UNarrativeComponent_IsQuestFailed, "IsQuestFailed" }, // 3232103404
		{ &Z_Construct_UFunction_UNarrativeComponent_IsQuestFinished, "IsQuestFinished" }, // 2677450105
		{ &Z_Construct_UFunction_UNarrativeComponent_IsQuestInProgress, "IsQuestInProgress" }, // 1310497261
		{ &Z_Construct_UFunction_UNarrativeComponent_IsQuestStartedOrFinished, "IsQuestStartedOrFinished" }, // 3242178949
		{ &Z_Construct_UFunction_UNarrativeComponent_IsQuestSucceeded, "IsQuestSucceeded" }, // 2507357871
		{ &Z_Construct_UFunction_UNarrativeComponent_Load, "Load" }, // 1391700259
		...
		{ &Z_Construct_UFunction_UNarrativeComponent_RestartQuest, "RestartQuest" }, // 2057406068
		{ &Z_Construct_UFunction_UNarrativeComponent_Save, "Save" }, // 2185247084
		{ &Z_Construct_UFunction_UNarrativeComponent_SaveComplete, "SaveComplete" }, // 2753690431
		{ &Z_Construct_UFunction_UNarrativeComponent_SelectDialogueOption, "SelectDialogueOption" }, // 169769187
		{ &Z_Construct_UFunction_UNarrativeComponent_ServerSelectDialogueOption, "ServerSelectDialogueOption" }, // 2619775382
		{ &Z_Construct_UFunction_UNarrativeComponent_ServerSelectSharedDialogueOption, "ServerSelectSharedDialogueOption" }, // 185833222
		{ &Z_Construct_UFunction_UNarrativeComponent_ServerTryExitDialogue, "ServerTryExitDialogue" }, // 2584084857
		{ &Z_Construct_UFunction_UNarrativeComponent_SetSharedNarrativeComponent, "SetSharedNarrativeComponent" }, // 1277473534
		{ &Z_Construct_UFunction_UNarrativeComponent_TryExitDialogue, "TryExitDialogue" }, // 320548672
	};
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnDialogueBegan = { "OnDialogueBegan", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeComponent, OnDialogueBegan), Z_Construct_UDelegateFunction_Narrative_OnDialogueBegan__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnDialogueBegan_MetaData), Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnDialogueBegan_MetaData) }; // 957205879
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnPlayerDialogueLineFinished = { "OnPlayerDialogueLineFinished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeComponent, OnPlayerDialogueLineFinished), Z_Construct_UDelegateFunction_Narrative_PlayerDialogueLineFinished__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnPlayerDialogueLineFinished_MetaData), Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_OnPlayerDialogueLineFinished_MetaData) }; // 940265994
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_SharedNarrativeComp_MetaData[] = {
		{ "Category", "Narrative" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Pointer to an optional shared narrative component. */" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/NarrativeComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Pointer to an optional shared narrative component." },
#endif
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_SharedNarrativeComp = { "SharedNarrativeComp", nullptr, (EPropertyFlags)0x001000000008003c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeComponent, SharedNarrativeComp), Z_Construct_UClass_UNarrativeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_SharedNarrativeComp_MetaData), Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_SharedNarrativeComp_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers_Inner = { "GroupMembers", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNarrativeComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers_MetaData[] = {
		{ "Category", "Narrative" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** All of the players sharing this component. Server tracks this so doesn't require replication */" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/NarrativeComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "All of the players sharing this component. Server tracks this so doesn't require replication" },
#endif
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers = { "GroupMembers", nullptr, (EPropertyFlags)0x001000800000001c, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeComponent, GroupMembers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers_MetaData), Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeComponent_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeComponent_Statics::NewProp_GroupMembers,
	...
	struct Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ScriptStructInfo[] = {
		...
		{ FNarrativeUpdate::StaticStruct, Z_Construct_UScriptStruct_FNarrativeUpdate_Statics::NewStructOps, TEXT("NarrativeUpdate"), &Z_Registration_Info_UScriptStruct_NarrativeUpdate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNarrativeUpdate), 786728611U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeComponent, UNarrativeComponent::StaticClass, TEXT("UNarrativeComponent"), &Z_Registration_Info_UClass_UNarrativeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeComponent), 4211856019U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_2662152373(TEXT("/Script/Narrative"),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_NarrativeComponent_h_Statics::EnumInfo));
