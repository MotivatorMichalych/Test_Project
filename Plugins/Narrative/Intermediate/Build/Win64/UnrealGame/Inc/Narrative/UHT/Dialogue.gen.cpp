...
template<> NARRATIVE_API UScriptStruct* StaticStruct<FPlayerSpeakerInfo>()
{
	...
	DEFINE_FUNCTION(UDialogue::execPlayDialogueShot)
	{
		P_GET_OBJECT(UNarrativeDialogueShot,Z_Param_Shot);
		P_GET_OBJECT(AActor,Z_Param_Speaker);
		P_GET_OBJECT(AActor,Z_Param_Listener);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PlayDialogueShot(Z_Param_Shot,Z_Param_Speaker,Z_Param_Listener);
		P_NATIVE_END;
	}
	...
	void UDialogue::StaticRegisterNativesUDialogue()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "PlayDialogueShot", &UDialogue::execPlayDialogueShot },
	...
	struct Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics
	{
		struct Dialogue_eventPlayDialogueShot_Parms
		{
			UNarrativeDialogueShot* Shot;
			AActor* Speaker;
			AActor* Listener;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Shot = { "Shot", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Dialogue_eventPlayDialogueShot_Parms, Shot), Z_Construct_UClass_UNarrativeDialogueShot_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Speaker = { "Speaker", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Dialogue_eventPlayDialogueShot_Parms, Speaker), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Listener = { "Listener", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Dialogue_eventPlayDialogueShot_Parms, Listener), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Shot,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Speaker,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::NewProp_Listener,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::Function_MetaDataParams[] = {
		{ "Category", "Dialogue" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Play a dialogue shot\n" },
#endif
		{ "ModuleRelativePath", "Public/Dialogue.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Play a dialogue shot" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDialogue, nullptr, "PlayDialogueShot", nullptr, nullptr, Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::Dialogue_eventPlayDialogueShot_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::Dialogue_eventPlayDialogueShot_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UDialogue_PlayDialogueShot()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UDialogue_PlayDialogueShot_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDialogue_PlayNPCDialogue_Statics::NewProp_Line = { "Line", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Dialogue_eventPlayNPCDialogue_Parms, Line), Z_Construct_UScriptStruct_FDialogueLine, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDialogue_PlayNPCDialogue_Statics::NewProp_Line_MetaData), Z_Construct_UFunction_UDialogue_PlayNPCDialogue_Statics::NewProp_Line_MetaData) }; // 316569442
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SharedDialoguePlayerAvatar_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_SharedDialoguePlayerAvatar;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OldPlayerRot_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_OldPlayerRot;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OldNPCRot_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_OldNPCRot;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDialogue_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDialogue_DestroySpeakerAvatar, "DestroySpeakerAvatar" }, // 3577352302
		{ &Z_Construct_UFunction_UDialogue_EndCurrentLine, "EndCurrentLine" }, // 1808400313
		{ &Z_Construct_UFunction_UDialogue_FinishDialogueNode, "FinishDialogueNode" }, // 2304827100
		...
		{ &Z_Construct_UFunction_UDialogue_GetAvatar, "GetAvatar" }, // 1878509699
		{ &Z_Construct_UFunction_UDialogue_GetConversationCenterPoint, "GetConversationCenterPoint" }, // 618781724
		{ &Z_Construct_UFunction_UDialogue_GetLineDuration, "GetLineDuration" }, // 1049416449
		{ &Z_Construct_UFunction_UDialogue_GetNodes, "GetNodes" }, // 4274221229
		{ &Z_Construct_UFunction_UDialogue_GetPlayerAvatar, "GetPlayerAvatar" }, // 2751508234
		{ &Z_Construct_UFunction_UDialogue_GetSpeakerHeadLocation, "GetSpeakerHeadLocation" }, // 1583175097
		{ &Z_Construct_UFunction_UDialogue_GetStringVariable, "GetStringVariable" }, // 3424861111
		{ &Z_Construct_UFunction_UDialogue_K2_OnBeginDialogue, "K2_OnBeginDialogue" }, // 2095241106
		{ &Z_Construct_UFunction_UDialogue_K2_OnEndDialogue, "K2_OnEndDialogue" }, // 1465803117
		{ &Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar, "LinkSpeakerAvatar" }, // 980636536
		{ &Z_Construct_UFunction_UDialogue_OnNPCDialogueLineFinished, "OnNPCDialogueLineFinished" }, // 2159719
		{ &Z_Construct_UFunction_UDialogue_OnNPCDialogueLineStarted, "OnNPCDialogueLineStarted" }, // 4255877430
		{ &Z_Construct_UFunction_UDialogue_OnPlayerDialogueLineFinished, "OnPlayerDialogueLineFinished" }, // 1527885983
		{ &Z_Construct_UFunction_UDialogue_OnPlayerDialogueLineStarted, "OnPlayerDialogueLineStarted" }, // 3214662753
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueAnimation, "PlayDialogueAnimation" }, // 911015831
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueNode, "PlayDialogueNode" }, // 3359068853
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueSequence, "PlayDialogueSequence" }, // 519786238
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueShot, "PlayDialogueShot" }, // 3729482454
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueSound, "PlayDialogueSound" }, // 1609801139
		{ &Z_Construct_UFunction_UDialogue_PlayNextNPCReply, "PlayNextNPCReply" }, // 3796383329
		{ &Z_Construct_UFunction_UDialogue_PlayNPCDialogue, "PlayNPCDialogue" }, // 3549363288
		{ &Z_Construct_UFunction_UDialogue_PlayPlayerDialogue, "PlayPlayerDialogue" }, // 2419515929
		{ &Z_Construct_UFunction_UDialogue_SkipCurrentLine, "SkipCurrentLine" }, // 797591022
		{ &Z_Construct_UFunction_UDialogue_StopDialogueAnimation, "StopDialogueAnimation" }, // 1246010673
		{ &Z_Construct_UFunction_UDialogue_StopDialogueSequence, "StopDialogueSequence" }, // 4034781205
		{ &Z_Construct_UFunction_UDialogue_TickDialogue, "TickDialogue" }, // 3151268684
	};
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_Speakers = { "Speakers", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, Speakers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_Speakers_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_Speakers_MetaData) }; // 4182834709
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_PlayerSpeakerInfo = { "PlayerSpeakerInfo", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, PlayerSpeakerInfo), Z_Construct_UScriptStruct_FPlayerSpeakerInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_PlayerSpeakerInfo_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_PlayerSpeakerInfo_MetaData) }; // 10544068
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDialogue_Statics::NewProp_DialogueCameraShake_MetaData[] = {
		{ "Category", "Camera" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Camera shake the dialogue camera will play. Defaults to a handheld camera shake by default.\n" },
#endif
		{ "ModuleRelativePath", "Public/Dialogue.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Camera shake the dialogue camera will play. Defaults to a handheld camera shake by default." },
#endif
	};
#endif
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_NPCActor = { "NPCActor", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, NPCActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_NPCActor_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_NPCActor_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDialogue_Statics::NewProp_SharedDialoguePlayerAvatar_MetaData[] = {
		{ "Category", "Dialogue" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//In shared dialogue, we sometimes need override the playeravatar to the other player that is speaking. To do that, we set this variable \n" },
#endif
		{ "ModuleRelativePath", "Public/Dialogue.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "In shared dialogue, we sometimes need override the playeravatar to the other player that is speaking. To do that, we set this variable" },
#endif
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_SharedDialoguePlayerAvatar = { "SharedDialoguePlayerAvatar", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, SharedDialoguePlayerAvatar), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_SharedDialoguePlayerAvatar_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_SharedDialoguePlayerAvatar_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDialogue_Statics::NewProp_OldPlayerRot_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Our players rot prior to beginning dialogue, so we can put him back where he was after making him face the conversation\n" },
#endif
		{ "ModuleRelativePath", "Public/Dialogue.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Our players rot prior to beginning dialogue, so we can put him back where he was after making him face the conversation" },
#endif
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_OldPlayerRot = { "OldPlayerRot", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, OldPlayerRot), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_OldPlayerRot_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_OldPlayerRot_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDialogue_Statics::NewProp_OldNPCRot_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Our players rot prior to beginning dialogue, so we can put him back where he was after making him face the conversation\n" },
#endif
		{ "ModuleRelativePath", "Public/Dialogue.h" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_OldNPCRot = { "OldNPCRot", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, OldNPCRot), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDialogue_Statics::NewProp_OldNPCRot_MetaData), Z_Construct_UClass_UDialogue_Statics::NewProp_OldNPCRot_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDialogue_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDialogue_Statics::NewProp_SharedDialoguePlayerAvatar,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDialogue_Statics::NewProp_OldPlayerRot,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDialogue_Statics::NewProp_OldNPCRot,
	...
	UDialogue::~UDialogue() {}
	struct Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ScriptStructInfo[] = {
		{ FSpeakerInfo::StaticStruct, Z_Construct_UScriptStruct_FSpeakerInfo_Statics::NewStructOps, TEXT("SpeakerInfo"), &Z_Registration_Info_UScriptStruct_SpeakerInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpeakerInfo), 4182834709U) },
		{ FPlayerSpeakerInfo::StaticStruct, Z_Construct_UScriptStruct_FPlayerSpeakerInfo_Statics::NewStructOps, TEXT("PlayerSpeakerInfo"), &Z_Registration_Info_UScriptStruct_PlayerSpeakerInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerSpeakerInfo), 10544068U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogue, UDialogue::StaticClass, TEXT("UDialogue"), &Z_Registration_Info_UClass_UDialogue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogue), 531117032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_2821065477(TEXT("/Script/Narrative"),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_demo_Plugins_Narrative_Source_Narrative_Public_Dialogue_h_Statics::ScriptStructInfo),
		nullptr, 0);
